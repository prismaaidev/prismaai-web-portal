      ...
      <section className="px-4 py-20 sm:px-6 lg:px-0 bg-slate-950">
        <div className="mx-auto max-w-7xl p-10 md:p-0">
          <div className="space-y-6 text-sm leading-7 text-slate-300 sm:text-base text-justify">
            <p>
              Welcome to our website, www.prisma.ai If you continue to browse
              and use this website, you are agreeing to comply with and be bound
              by the following terms and conditions of use, which together with
              our privacy policy govern Prisma’s relationship with you in
              relation to this website. If you disagree with any part of these
              terms and conditions, please do not use our website.
            </p>
            <p>
              {
                'The term "Prisma AI" or "us" or "we" refers to the owner of the website. The term "you" refers to the user or viewer of our website.'
              }
            </p>
            ...
            <p>
              ...
              of the website is subject to the laws of Singapore .
            </p>
          </div>
        </div>
      </section>
